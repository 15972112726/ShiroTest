 ...
 *
 */
package cn.zz.Daili.WEB;

import cn.zz.Daili.util.proxyServer;
...
public class HTMLDownloader {
	...
	//代理服务器
	String proxyIP = proxyServer.proxyIP[0];
	//代理服务器端口
	...
	public static void main(String[] args) {
		...
		downLoader.downloadFile("http://i2.dpfile.com/2009-10-31/3049378_m.jpg", false);
